...
<div className="row">
    <div className="col-md-6 text-right">
        <svg version="1.1"  className="icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30px" height="30px" xml:space="preserve">
    ...
    <div className="col-md-6">{{ ngCart.getTotalItems() }}
